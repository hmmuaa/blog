...
///两层参数
fn2=a=>b=>log(a,b,new Error().stack.includes('fn'))
fn2(11)(22)///11 22 Error,Object.<anonymous>
log(3)
fn3=a=>b=>log(a,b,new Error().stack.includes('fn'))(11)
fn3(22)///无输出
log(4)
fn4=a=>(b=>log(a,b,new Error().stack))(11)
fn4(22)///22 11 Error,testFn⭕
log(5)
fn5=(a=>b=>log(a,b,new Error().stack.includes('fn')))(11)
...
///#返回结果
log=(...a)=>(console.log(...a),a)///可以返回，但必须一个整体
...
log=(...a)=>(b=new Error().stack
	.split(' (/')[1]///以上两种写法都正好在两个“ (/”中间
	.split(' ').last()///“at ”、“async ”
	///如果在文件第一层则为“Object.<anonymous>”
	,b=='Object.<anonymous>'?console.log(...a):console.log(
