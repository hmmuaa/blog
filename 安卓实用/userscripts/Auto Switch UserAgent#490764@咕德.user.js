...
// @match        *://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/490764/Auto%20Switch%20UserAgent.user.js
// @updateURL https://update.greasyfork.org/scripts/490764/Auto%20Switch%20UserAgent.meta.js
// ==/UserScript==
...
(function () {
    ...
    if (!matchedUaKey) {
        for (const domain in urlUaMap) {
            if (currentDomain.includes(domain)) {
                matchedUaKey = urlUaMap[domain];
                break;
            }
        }
    }
